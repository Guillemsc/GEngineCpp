...
*
*   rlgl library is an abstraction layer for multiple OpenGL versions (1.1, 2.1, 3.3 Bootstraps, ES 2.0)
*   that provides a pseudo-OpenGL 1.1 immediate-mode style API (rlVertex, rlTranslate, rlRotate...)
*
*   WARNING: This example is intended only for PLATFORM_DESKTOP and OpenGL 3.3 Bootstraps profile.
...
int main(void)
{
    ...
    // WARNING: OpenGL 3.3 Bootstraps profile only
...
//----------------------------------------------------------------------------------
// Modules specific Functions Definitions
//----------------------------------------------------------------------------------

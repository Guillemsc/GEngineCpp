...
//----------------------------------------------------------------------------------
extern void LoadFontDefault(void);          // [Modules: text] Loads default font, required by ImageDrawText()
...
Image ImageText(const char *text, int fontSize, Color color)
{
    ...
    imText = ImageTextEx(GetFontDefault(), text, (float)fontSize, (float)spacing, color);   // WARNING: Modules required: rtext
#else
...
// WARNING: Modules required: rtext
Image ImageTextEx(Font font, const char *text, float fontSize, float spacing, Color tint)
{
    ...
    Vector2 imSize = MeasureTextEx(font, text, (float)font.baseSize, spacing);  // WARNING: Modules required: rtext
    ...
    for (int i = 0; i < size;)
    {
        ...
        int codepoint = GetCodepointNext(&text[i], &codepointByteCount);    // WARNING: Modules required: rtext
        int index = GetGlyphIndex(font, codepoint);                         // WARNING: Modules required: rtext
...
void ImageDrawText(Image *dst, const char *text, int posX, int posY, int fontSize, Color color)
{
    ...
    ImageDrawTextEx(dst, GetFontDefault(), text, position, (float)fontSize, 1.0f, color);   // WARNING: Modules required: rtext
#else
